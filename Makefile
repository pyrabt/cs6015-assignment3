...
cover:
	...
	-LLVM_PROFILE_FILE="e3_2.profraw" ./classifier < testCaseFiles/error3_1.txt
	-LLVM_PROFILE_FILE="e3_3.profraw" ./classifier < testCaseFiles/error3_1.txt
	-LLVM_PROFILE_FILE="e4_1.profraw" ./classifier < testCaseFiles/error4_1.txt
	-LLVM_PROFILE_FILE="e4_1.profraw" ./classifier < testCaseFiles/error4_1.txt
	xcrun llvm-profdata merge -sparse sInput1.profraw e1_1.profraw e1_2.profraw e1_3.profraw e1_4.profraw e1_5.profraw e2_1.profraw e3_1.profraw e3_2.profraw e3_3.profraw e4_1.profraw e4_1.profraw -o classifier.profdata
	rm -f e1_1.profraw e1_2.profraw e1_3.profraw e1_4.profraw e1_5.profraw e2_1.profraw e3_1.profraw e3_2.profraw e3_3.profraw e4_1.profraw e4_1.profraw

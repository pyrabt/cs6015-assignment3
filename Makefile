...
cover:
	...
	xcrun llvm-profdata merge -sparse sInput1.profraw e1_1.profraw e1_2.profraw e1_3.profraw e1_4.profraw e1_5.profraw e2_1.profraw -o classifier.profdata
	rm -f e1_1.profraw e1_2.profraw e1_3.profraw e1_4.profraw e1_5.profraw e2_1.profraw
